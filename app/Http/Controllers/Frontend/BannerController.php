...
class BannerController extends Controller
{
    ...
    {
        return view('backend.website.homepage.banner.list');
    }

    // List
    public function list()
    {
        $banner = Banner::with(['product'])->orderBy('status', 'desc')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $banner->tag = strtoupper($request->tag);
    ...
    public function toggleProductStatus(Request $request)
    {
        ...
        try {
            $banner = Banner::findOrFail($request->id);
            $banner->product_id = $request->product_id ?? 0;   
            $banner->save();
