    ...
    <div class="card-header">
        ...
        <div class="row flex-between-end">
            ...
            <div class="col-auto align-self-center">
                ...
                <h5 class="mb-0" data-anchor="data-anchor">All Bookings - Completed</h5>
    ...
    $(document).ready(function() {
        ...
        function fetchBookings() {
            ...
            $.ajax({
                ...
                url: "{{ route('doctor.bookings.completed.get') }}",
                ...
                class="badge ${booking.status == 0 ? 'bg-success' : booking.status == 1 ? 'bg-success' : 'bg-danger'}"  

                data-id="${booking.id}">

                ${booking.status == 0 ? 'Confirmed' : booking.status == 1 ? 'Completed' : 'Cancelled'}
