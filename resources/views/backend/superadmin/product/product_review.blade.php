        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Product Reviews</h5>
                </div>
            </div>
        </div>
        <div class="card-body pt-0">
            <div class="tab-content">
                ...
                <div id="tableExample3"
                    data-list='{"valueNames":["product","name","email","rating"],"page":10,"pagination":true}'>
                        ...
                        <table class="table table-bordered table-striped fs-10 mb-0">
                            <thead class="bg-200">
                                <tr>
                                    ...
                                    <th class="text-900" data-sort="product">Product</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchReview() {
                ...
                $.ajax({
                    url: "{{ route('product.reviews.list') }}",
                    type: "GET",
                    success: function(data) {
                        ...
                        $.each(data, function(index, review) {
                            ...
                            if (Array.isArray(images) && images.length > 0) {
                                ...
                                $.each(images, function(i, imgPath) {
                                    imagesHtml += `
                <a href="{{ url('/') }}/${imgPath}" target="_blank">
                    <img src="{{ url('/') }}/${imgPath}" alt="review image" class="rounded border" style="width:60px; height:60px; object-fit:cover;">
                </a>
            `;
                                });
                                imagesHtml += '</div>';
                        ...
                        <td>${index + 1}</td>
                        <td class="product">
                        <a href="{{ url('/') }}/product/${review.product.slug}" target="_blank">${review.product.product_name}</a>
                        </td>
                        <td class="name">
                         ${review.name}
                        </td>
                        ...
                        new List('tableExample3', {
                            valueNames: ['product', 'name', 'email', 'rating'],
                            page: 10,
                            pagination: true
                        });
                    },
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: `/vendor/product/review/${reviewId}`,
                            type: "DELETE",
