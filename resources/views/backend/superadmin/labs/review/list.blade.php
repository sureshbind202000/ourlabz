                ...
                success: function(data) {
                    ...
                    $.each(data, function(index, review) {
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input status-toggle" type="checkbox" @if(has_permission('reviews', 'edit')) data-id="${review.id}" @endif ${review.is_active == 1 ? 'checked' : ''} />
                        </div>
                        </td>
                        <td class="date">${formatDate(review.created_at)}</td>
                        <td>
                        <div>
                            @if (has_permission('reviews', 'delete'))
                    ...
                    new List('tableExample3', {
                        valueNames: [ 'name', 'email', 'date', 'rating'],
                        page: 10,
                        pagination: true
                    });
                }
