        ...
        <div class="card-header">
            <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Corporate Banners</h5>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchBanner() {
                ...
                $.ajax({
                    url: "{{ route('corporate.banner.list') }}",
                    type: "GET",
            ...
            $(document).ready(function() {
                ...
                $('#submitBtn').on('click', function(e) {
                    ...
                    if ($("#storeBanner").valid()) {
                        ...
                        $.ajax({
                            url: "{{ route('corporate.banner.store') }}",
                            type: "POST",
                            data: formData,
                            contentType: false,
                            processData: false,
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                $.ajax({
                    url: '/corporate-banner/' + bannerId + '/edit',
                    type: 'GET',
                    success: function(response) {
            ...
            $(document).on('change', '.status-toggle', function() {
                ...
                $.ajax({
                    url: "{{ route('corporate.banner.status') }}", // Create this route
                    type: "POST",
                    data: {
                        id: bannerId,
                        status: status
