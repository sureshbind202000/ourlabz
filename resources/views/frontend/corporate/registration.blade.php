        ...
        <div class="shop-checkout">
            ...
            <div class="container-fluid">
                ...
                <div class="row form ">
                    ...
                    <div class="d-none d-lg-block  col-lg-6 ps-0">



                        <img src="{{ asset('assets/img/corporate/corp_reg.png') }}" alt="" class="doctor-reg-image">
                    ...
                    <div class="col-sm-12 col-lg-6 bg-white">
                        ...
                        <div class="billing-container p-4">
                            ...
                            <h2 class="text-center py-1 "><strong class="text-dark">Corporate</strong> <span

                                    class="text-primary">Registration Form</span></h2>
                            ...
                            <form id="msform" class="">
                                ...
                                <ul id="progressbar">
                                    ...
                                    <li class="active " id="personal" style="text-align: center;"><strong>Company

                                            Details</strong></li>



                                    <li id="location" style="text-align: center;"><strong>Contact Information</strong></li>
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="company_name"
                                                        ...
                                                        class="form-control shadow-none" id="comp_name"
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <label for="compregno">Company Registration No

                                                    <small>(CIN/GST/etc)</small></label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="company_reg_no"
                                                        ...
                                                        class="form-control shadow-none" id="compregno"
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control shadow-none" name="company_size"

                                                        id="compsize" required>
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <label for="styear">Establishment Year</label>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" name="establishment_year"
                                                        ...
                                                        class="form-control shadow-none" id="styear" required />
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="website_url"
                                                        ...
                                                        class="form-control shadow-none" id="weburl"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" name="date_of_birth"
                                                        ...
                                                        class="form-control shadow-none" id="dob" required />
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" name="phone" class="form-control shadow-none"

                                                        id="contactNumber" placeholder="+1 987 654 321" />
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" name="alternate_phone"
                                                        ...
                                                        class="form-control shadow-none" id="alternateNumber"
                                            ...
                                            <div class="mb-4 col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control shadow-none"
                                                        ...
                                                        id="officeEmail" placeholder="Email" required />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-4 col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="username"
                                                        ...
                                                        class="form-control shadow-none" id="username"

                                                        placeholder="Alphanumeric Username" pattern="[A-Za-z0-9]+"
                                            ...
                                            <div class="mb-3 col-12">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input shadow-none" name="terms_condition"

                                                        type="checkbox" id="consentTerms" required>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function maskPhoneAndEmail(phone, email) {
                ...
                const maskedPhone = phone.replace(/\d(?=\d{4})/g, 'x').replace(/(\d{3})(\d{3})(\d{4})/,
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        $.ajax({
                            ...
                            url: "{{ route('corporate.store.registration') }}",
                            ...
                            success: function(response) {
                                ...
                                Toast.fire({
                                    ...
                                    title: 'Corporate registered successfully!'
