                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="shop-cart-img">
                                                    <a href="#"><img src="assets/img/test/kidneys.png" alt=""></a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shop-cart-content">
                                                    <h5 class="shop-cart-name"><a href="#">Kidney Check Basic</a></h5>
                                                    <div class="shop-cart-info">
                                                        <p><span>Parameters:</span> 91 Test</p>
                                                        <p><span>Reports With in:</span>8 Hours</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="shop-cart-img">
                                                    <a href="#"><img src="assets/img/test/Diabetes.jpg" alt=""></a>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="shop-cart-content">
                                                    <h5 class="shop-cart-name"><a href="#">Diabetes Panel - Essential</a></h5>
                                                    <div class="shop-cart-info">
                                                        <p><span>Parameters:</span> 91 Test</p>
                                                        <p><span>Reports With in:</span>8 Hours</p>
                                                    </div>
