                        ...
                        <div class="offcanvas-body">
                            ...
                            <ul class="navbar-nav flex-grow-1 justify-content-center">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link small fw-bold book-test" href="{{ route('lab.test') }}">Book
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link small fw-bold" href="{{ route('doctor_category') }}">Doctor</a>

                                </li>

                                <li class="nav-item mega-menu dropdown">

                                    <a class="nav-link small fw-bold dropdown-toggle"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-lg-2">
                                                        ...
                                                        <ul class="mega-menu-item">
                                                            ...
                                                            <li><a class="dropdown-item" href="shop-grid.html">Allergies

                                                                    &

                                                                    Sinus</a></li>

                                                            <li><a class="dropdown-item" href="shop-grid.html">E.N.T

                                                                    Preparations</a></li>

                                                            <li><a class="dropdown-item" href="shop-grid.html">Eye

                                                                    Preparations</a></li>

                                                            <li><a class="dropdown-item" href="shop-grid.html">Vitamin &

                                                                    Nutritional</a></li>

                                                            <li><a class="dropdown-item" href="shop-grid.html">Fever &
                                                    ...
                                                    <div class="col-12 col-lg-2">
                                                        ...
                                                        <ul class="mega-menu-item">
                                                            ...
                                                            <li><a class="dropdown-item" href="shop-grid.html">Biopsy
                                                            ...
                                                            <li><a class="dropdown-item"
                                                                    ...
                                                                    href="shop-grid.html">Lighting</a>

                                                            </li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Machines</a>

                                                            </li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Thermometer</a>
                                                    ...
                                                    <div class="col-12 col-lg-2">
                                                        ...
                                                        <ul class="mega-menu-item">
                                                            ...
                                                            <li><a class="dropdown-item"
                                                                    ...
                                                                    href="shop-grid.html">Surgical

                                                                    Sutures</a></li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Bandages</a>

                                                            </li>

                                                            <li><a class="dropdown-item" href="shop-grid.html">Patches
                                                            ...
                                                            <li><a class="dropdown-item" href="shop-grid.html">Wound

                                                                    Healing</a></li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Uniforms</a>
                                                    ...
                                                    <div class="col-12 col-lg-2">
                                                        ...
                                                        <ul class="mega-menu-item">
                                                            ...
                                                            <li><a class="dropdown-item" href="shop-grid.html">Face

                                                                    Masks</a></li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Sterilization</a></li>
                                                            ...
                                                            <li><a class="dropdown-item"
                                                                    ...
                                                                    href="shop-grid.html">Disposable

                                                                    Products</a></li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Protective

                                                                    Covers</a></li>

                                                            <li><a class="dropdown-item"

                                                                    href="shop-grid.html">Diagnostic
